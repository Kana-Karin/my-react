          ...
          <MDBCardBody>
            ...
            <MDBCardText>
              ...
              <Tabs defaultActiveKey="1" centered>
                ...
                ルーターの設定やデータベース、認証、理解を深めるために、ググりながら作成しました。セキュリティ面にまでは届きませんでしたが、いずれは予約サイトやECサイトの構築を目標にしています。
                </TabPane>
              </Tabs>
              {/* Tabs end */}
            </MDBCardText>
        ...
        <MDBCard className='h-100'>
          ...
          <MDBCardTitle>Reactポートフォリオ
            ...
            <MDBCardText>
              ...
              <Tabs defaultActiveKey="1" centered>
                <TabPane tab="使用ツール・環境" key="1">
                  <p>環境:  React.js/TypeScript</p>
                  <p>UI:  MDB/Ant Design</p>
                </TabPane>
                <TabPane tab="詳細" key="2">
                <p>当サイトです。元々はVueで作成していましたが、パフォーマンス、トレンドを踏まえて、React.jsを選択しました。</p>
          ...
          <MDBCardBody>
            ...
            <MDBCardText>
              ...
              <Tabs defaultActiveKey="1" centered>
                ...
                <TabPane tab="詳細" key="2">
                  コンペ応募作品です。外国の方もご利用されること想定して和モダンを意識し、アクセントカラーには小豆色を使用。落ち着いたデザインにしました。
                </TabPane>
                <TabPane tab="コメント" key="3">
                </TabPane>
              </Tabs>
